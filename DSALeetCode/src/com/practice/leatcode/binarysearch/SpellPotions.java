...
Return an integer array pairs of length n where pairs[i]
...
public class SpellPotions {
	...
	public static void main(String[] args) {
		...
		System.out.print("elements of pairs are : ");
	...
	public static int[] successfulPairs(int[] spells, int[] potions, long success) {
		...
		for (int i = 0; i < spells.length; i++) {
			int cutOff = startingRange(potions, spells[i], success);
			pairs[i] = potions.length - cutOff;
		}
		return pairs;
	}

	private static int startingRange(int[] potions, int spell, long success) {
		int low = 0;
